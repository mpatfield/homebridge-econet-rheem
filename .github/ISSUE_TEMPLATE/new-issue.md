...
* Which version of this plugin (homebridge-econet-rheem) do you have? Has the issue started since upgrading from a previous version?



* Which Rheem devices do you have that are causing issues? Please include product models if applicable.
